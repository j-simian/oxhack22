...
def main():
    ...
    while True:
        ...
        if state == State.MENU:
            ...
            if mapNum > 0:
                map_name = {1: "res/mapold.json", 2: "res/spidermap.json", 3: "res/snowdin.json", 4: "res/gentleman.json", 5: "res/rishmap.json", 6: "res/megalovania.json", 7: "res/cow.json"}[mapNum]
